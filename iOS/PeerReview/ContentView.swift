        ...
        NavigationStack {
            ...
            .overlay {
                if store.entries.isEmpty {
                    ContentUnavailableView("No Reviews Yet", systemImage: "tray", description: Text("Tap + to add your first entry."))
                }
            }
        ...
        NavigationStack {
            Form {
                Section("Review") {
                    ...
                    TextField("Details (peer / due date)", text: $detail)
                    DatePicker("Date", selection: $date, displayedComponents: .date)
                }
            }
            .navigationTitle(entry == nil ? "Add Review" : "Edit Review")
            .toolbar {
