...
final class Store: ObservableObject {
    ...
    private let fileName = "peerreview_entries.json"
    ...
    static func seedData() -> [Entry] {
        let now = Date()
        return [
            Entry(title: "Sample Review One", detail: "First example entry.", date: now),
            Entry(title: "Sample Review Two", detail: "Second example entry.", date: now.addingTimeInterval(-86400)),
            Entry(title: "Sample Review Three", detail: "Third example entry.", date: now.addingTimeInterval(-172800)),
        ]
    }
}
